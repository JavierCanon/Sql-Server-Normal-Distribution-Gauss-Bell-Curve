<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Pivot_DistribucionNormVentas_Pregenerado.aspx.cs"
    Inherits="BINumber_Web.Web.Auditoria.Queries.Pivot_DistribucionNormVentas_Pregenerado" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
        ...
        <small>Consulta Pivote Distribucion Normal Ventas</small>
    </h1>

    <hr />

    <dx:ASPxPivotGrid ID="pivotGrid" runat="server" DataSourceID="masterDataSource"
        Caption="Pivote Distribucion Normal de Ventas"
        SaveStateToCookiesID="Pivot_DistribucionNormVentasMensual"
        Width="100%"
        ...
        OnCustomCellStyle="ASPxPivotGrid1_CustomCellStyle"
           ...
           <dx:PivotGridField Area="ColumnArea" AllowedAreas="ColumnArea" AreaIndex="1" FieldName="Fecha"
            ...
            <dx:PivotGridField Area="RowArea" AllowedAreas="RowArea" AreaIndex="1"
                FieldName="Rn" ID="PivotGridField_Rn" 
                Caption="N">
            </dx:PivotGridField>

            <dx:PivotGridField Area="DataArea" AreaIndex="1" FieldName="NormalDist" ID="PivotGridField_DistNormalAc"
                CellFormat-FormatString="{0:n15}" CellFormat-FormatType="Custom" EmptyValueText="0" EmptyCellText="0"
                Caption="DistNormal" AllowedAreas="DataArea" SummaryType="Average" />
            ...
            <dx:PivotGridField Area="DataArea" AreaIndex="3" FieldName="SUMValorBruto" ID="PivotGridField_ValorBruto"
                CellFormat-FormatString="{0:n3}" CellFormat-FormatType="Custom" EmptyValueText="0" EmptyCellText="0"
    ...
    <dx:WebChartControl ID="WebChartControl1" runat="server" CrosshairEnabled="True"
        ...
        <DiagramSerializable>
            <dx:XYDiagram>
                <AxisX Title-Text="ValorBruto" Title-Visibility="False">
                    <Label TextPattern="{A:n2}"></Label>
                </AxisX>
                <AxisY Title-Text="DistNormal" Title-Visibility="False" Visibility="False">
        ...
        <Legend MaxHorizontalPercentage="30" Name="Default Legend" Visibility="True" MarkerMode="CheckBoxAndMarker"></Legend>

        <SeriesSerializable>
            <dx:Series Name="Series 1" ArgumentDataMember="YAxis" ValueDataMembersSerializable="NormalDist" ArgumentScaleType="Numerical"
                CrosshairEnabled="True" ValueScaleType="Numerical" CrosshairLabelPattern="{A:n}">
                <ViewSerializable>
                    <dx:SplineSeriesView ColorEach="True" MarkerVisibility="False">
                        <LineMarkerOptions>                            
                        </LineMarkerOptions>
                    </dx:SplineSeriesView>
                </ViewSerializable>
                <LabelSerializable>
                    <dx:PointSeriesLabel TextPattern="{A:n}"></dx:PointSeriesLabel>
                </LabelSerializable>
            </dx:Series>
            <dx:Series Name="Series 2" ArgumentDataMember="SUMValorBruto" ValueDataMembersSerializable="NormalDist" >
        ...
        <Titles>
            <dx:ChartTitle Text="Distribucion de la Normal"></dx:ChartTitle>
        </Titles>
    </dx:WebChartControl>
